...
bool JtagAnalyzerSettings::SetSettingsFromInterfaces()
{
    ...
    Channel all_channels[ NUM_CHANNELS ] = { mTmsChannelInterface.GetChannel(), mTckChannelInterface.GetChannel(),
                                             mTdiChannelInterface.GetChannel(), mTdoChannelInterface.GetChannel(),
